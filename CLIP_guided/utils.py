...
from CLIP_guided.CLIP.tokenizer import tokenize


def encode_text_with_prompt_ensemble(model, obj, device): #obj就只有类似'brain'
    ...
    #flawless:完美;unblemished:无瑕疵的；flaw：缺陷
